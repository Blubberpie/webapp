...
public class Messages {
    ...
    public static final String errNoUserGiven = "No user was given!";
    ...
    public static final String msgUserRemoved = "You removed a user!";
    public static final String msgUserAdded = "You added a user!";
}
